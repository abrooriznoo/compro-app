...
<body
    ...
    <div
        ...
        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 10px;">
            ...
            <h2 style="margin:0; color:#333; letter-spacing:1px;">✖️ Multiplication</h2>
        </div>

        <form method="POST" action="{{ route('arithmetic.multiplication.calculate') }}" style="margin-top:25px;">
            @csrf
        ...
        @if (isset($result))
            ...
            <button type="button"
                ...
                onclick="window.location.href='{{ route('arithmetic.multiplication') }}'">
                Reset
            </button>
        @endif
    </div>
